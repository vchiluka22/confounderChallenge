...
ax.set_title("Post-Surgical Symptom Score by Patient and Doctor", fontsize=14, pad=10)
...
ax.set_title("Post-Surgical Symptom Score (Randomized Assignment)", fontsize=14, pad=10)
ax.set_xlabel("Patient Number", fontsize=12)
ax.set_ylabel("Post-Surgical Symptom Score (Lower is Better)", fontsize=12)
...
ax.set_title("Post-Surgical Symptom Score by Patient Severity", fontsize=14, pad=10)
